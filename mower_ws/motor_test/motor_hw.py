...
class BTS7960Motor:
    """
    BTS7960-style control:
      - Enable pins: R_EN, L_EN (both ON to enable)
      - Direction/speed using PWM pins:
          forward:  R_PWM = duty, L_PWM = 0
          reverse:  L_PWM = duty, R_PWM = 0
    speed command is in [-1.0, +1.0]
    """
    def __init__(
        self,
        name: str,
        ...
        # gpiozero PWMOutputDevice works with software PWM unless pigpio is used.
